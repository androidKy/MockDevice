...
public class ProviderPicker {
    private static final String TAG = "ProviderPicker";
    ...
    public static Provider getProvider(ParcelFileDescriptor descriptor, LocalVpnService service) {
       // int dnsQueryMethod = getDnsQueryMethod();
       // L.i("dnsQueryMethod: "+dnsQueryMethod);
        return new UdpProvider(descriptor, service);
       /* switch (dnsQueryMethod) {
