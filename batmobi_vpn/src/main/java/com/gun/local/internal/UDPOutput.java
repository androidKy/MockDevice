...
public class UDPOutput implements Runnable {
    ...
    public UDPOutput(LinkedBlockingQueue<Packet> inputQueue, Selector selector, LocalVPNService vpnService) {
        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    Logs.e(TAG, "Network write error: " + ipAndPort, e);
